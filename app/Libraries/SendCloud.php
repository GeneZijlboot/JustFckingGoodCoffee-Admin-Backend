...
class SendCloud {
    ...
    {
        //setting the apiUrl
        $this->apiUrl = "https://panel.sendcloud.sc/api";
    }

    //Mollie request function
    public function performSendCloudRequest (&$data = [], &$message = null) {
        //parameters
        $status = true;
    ...
    public function createOrder($apiKey, &$data = [], &$message = null) {
        $data = [
            'method' => 'POST',
            'uri' => '/v3/orders',
            'apikey' => $apiKey,
        ...
        return $this->performSendCloudRequest($data, $message);
    }
}